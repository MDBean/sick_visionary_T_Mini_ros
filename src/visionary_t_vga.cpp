...
std::shared_ptr<VisionaryTData> gDataHandler;

image_transport::Publisher gPubDepth, gPubIntensity;
...
void thr_receive_frame(std::shared_ptr<VisionaryDataStream> pDataStream, std::shared_ptr<VisionaryTData> pDataHandler)
{
    while (gReceive)
    {
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "sick_visionary_t_vga");
    ros::NodeHandle nh("~");
    ...
    std::shared_ptr<VisionaryTData> pDataHandler = std::make_shared<VisionaryTData> ();
    ...
    ROS_INFO("Connected with Visionary-T VGA");
